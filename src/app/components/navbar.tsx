...
// // // // //                 <Link 
// // // // //                   href="/whats-new" 
// // // // //                   className="text-[14px] font-medium text-gray-800 hover:text-gray-600"
// // // // //                 >
// // // // //                   What&apos;s New
// // // // //                 </Link>
// // // // //                 <Link 
...
// // // //                   {isCartOpen && (
// // // //                     <span className="absolute top-0 right-0 bg-red-500 text-white rounded-full w-4 h-4 flex items-center justify-center text-xs">
// // // //                       0 {/* Here, you can pass cartCount dynamically from ShoppingCart component */}
// // // //                     </span>
// // // //                   )}
// // // //                 </button>

// // // //                 {/* Pass the state and function to ShoppingCart component */}
// // // //                 {isCartOpen && (
// // // //                   <div className="absolute right-0 mt-2 w-96 bg-white shadow-lg rounded-lg z-10">
// // // //                     <ShoppingCart isOpen={isCartOpen} setIsOpen={setIsCartOpen} />
// // // //                   </div>
...
// // //                   <span className="absolute top-0 right-0 bg-red-500 text-white rounded-full w-4 h-4 flex items-center justify-center text-xs">
// // //                     {/* This will be dynamic from ShoppingCart component */}
// // //                     0
// // //                   </span>
// // //                 </button>
...
// //                 {isCartOpen && cartDetails && (
// //                   <div className="absolute right-0 mt-2 w-[280px] sm:w-96 bg-white shadow-lg rounded-lg z-10 max-h-[calc(100vh-120px)]">
// //                     <div className="flex flex-col p-4 sm:p-6 h-full">
// //                       <h2 className="text-xl font-semibold mb-4">Your cart</h2>
                      
// //                       {/* Scrollable Cart Items */}
// //                       <div className="flex-1 overflow-y-auto max-h-[60vh] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
// //                         <ul className="flex flex-col divide-y dark:divide-gray-300">
// //                           {Object.values(cartDetails).map((item: any) => (
